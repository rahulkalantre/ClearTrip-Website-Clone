import EmiLogo from "../Assets/FlightReviewPage/EmiLogo.svg";
import ICICI from "../Assets/Images/ICICI";
import Offer from "../Assets/FlightReviewPage/CT_offer.png";
import HDFC from "../Assets/FlightReviewPage/HDFC.svg";
import Citi from "../Assets/FlightReviewPage/Citi.svg";


function RightSideFlightItineary() {
    return (
      <>
        <aside>
          <div className="aside">
  ...
  export default RightSideFlightItineary;